...
import { View, Text, Button,ScrollView ,SafeAreaView, TextInput, StyleSheet } from "react-native";
...
function handleMessageSend (){
    ...
    return (
        <View style={{ height: '100%' }}>
            <ScrollView>
            <View style={{ height: '85%',marginLeft:10,marginRight:10, marginTop:10 }} >
                {messages.map(
            ...
            <View style={{ height: '15%', display:'flex',flexDirection:'row', alignItems:'center',justifyContent:'space-around', padding:3}} >
                <TextInput
                    style={styles.input}
                    onChangeText={(text) => { setInputValue(text); setUserText(text) }}
