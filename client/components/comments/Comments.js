...
function Comments() {
  ...
  const [comments, setComments] = useState([
    {name: 'Yarn', comment: 'wow so cute '},
    {name: 'Yarn', comment: 'wow so cute '},
    {name: 'Yarn', comment: 'wow so cute '},
    {name: 'Yarn', comment: 'wow so cute '},
    {name: 'Yarn', comment: 'wow so cute '},
    {name: 'Kelly', comment: 'wow so cute '},
    {name: 'boris', comment: 'greate'},
    {name: 'Tiku', comment: 'am happy for you bro  '},
    {name: 'Kelvin', comment: 'confirm'},
    {name: 'Mark', comment: 'wow  I love this '},
  ]);
